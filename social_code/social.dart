...
class SocialpageState extends State<Socialpage> {
  ...
  void getPostsData() async{
    ...
    // popular posts documents count
    final QuerySnapshot queryresultPopular = await Firestore.instance.collection('Social_Posts').where("views", isGreaterThan: 25).getDocuments();
    final List<DocumentSnapshot> querydocumentsPopular = queryresultPopular.documents;
    print(querydocumentsPopular.length);
    var len = (querydocumentsPopular.length).toString();
    _items = len + " Items";
    // your posts documents count
    final result_your = await Firestore.instance.collection('Social_Posts').where("userEmail", isEqualTo: "${user?.email}").getDocuments();
            ...
            children: <Widget>[
              new GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => popularPosts()),
                  );
                },
                child: Container(
                  width: 150,
              ...
              new GestureDetector(
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => your_posts()),
                  );
                },
                child: Container(
                  width: 150,
