...
class Popular_posts extends StatefulWidget {
  @override
  Popular_postsState createState() => Popular_postsState();
}

class Popular_postsState extends State<Popular_posts> {
  ...
  void getPostsData() async{
    ...
    final result = await Firestore.instance.collection('Social_Posts').where("views", isGreaterThan: 25).getDocuments();
    final List<DocumentSnapshot> documents = result.documents;
