...
class feedbackUpload extends StatelessWidget {
  @override
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: <Widget>[
          ...
          new Text("Submit Feedback", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 40),textAlign: TextAlign.center,),
          SizedBox(height: 55.0,),
          new TextFormField(
            controller: postTitle,
            decoration: new InputDecoration(
              labelText: "Enter Feedback title",
          ...
          new TextFormField(
            ...
            decoration: new InputDecoration(
              labelText: "Enter Feedback Content",
              fillColor: Colors.white,
            ...
            onPressed: () {
              ...
              if((postTitle.text).length <= 5){
                ...
                Firestore.instance.collection("Feedback")
                    .document()
                    .setData({"postTitle" : postTitle.text, "postContent" : postContent.text, "userEmail" : "${user?.email}", "likes" : 0, "dislikes" : 0})
                    .then((signedInUser){
                  Scaffold.of(context).showSnackBar(SnackBar(content: Text('Feedback Sent!', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),), backgroundColor: Colors.green,));
                  print("done");
