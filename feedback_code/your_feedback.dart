...
class yourFeedback extends StatelessWidget {
  @override
...
class Your_feedback extends StatefulWidget {
  @override
  Your_feedbackState createState() => Your_feedbackState();
}

class Your_feedbackState extends State<Your_feedback> {
  ...
  void getPostsData() async{
    ...
    print("${user?.email}");
    final result = await Firestore.instance.collection('Feedback').where("userEmail", isEqualTo: "${user?.email}").getDocuments();
